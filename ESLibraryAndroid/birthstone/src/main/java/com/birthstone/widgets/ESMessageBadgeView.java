...
/**
 * 一个简单的文本标签视图，可以作为任何UIView的“未读消息数”应用
 */
public class ESMessageBadgeView extends TextView
{
	...
	public ESMessageBadgeView (Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}

	public ESMessageBadgeView (Context context, AttributeSet attrs) {
     ...
     */
	public ESMessageBadgeView (Context context, View target) {
     ...
     */
	public ESMessageBadgeView (Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}

	public ESMessageBadgeView (Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}

	public ESMessageBadgeView (Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
